...
(function(scope) {
  ...
  scope.chart = function(data, config) {
    ...
    config.targetPadding = config.targetPadding || 3;
    ...
    function groupInfo(d) {
      ...
      infoTimer = setTimeout(function() {
        ...
        var text = info.select('.text').selectAll('text')
          .data([
            data.names[d.id],
            'Total: ' + formatNumber(d.inflow + d.outflow)
          ]);
    ...
    function draw(year, countries) {
      ...
      groupTextGroup.enter()
        ...
        .attr('class', 'label');
      groupTextGroup
        //.filter(function(d) {return d.id !== d.region})  //YOHERE
        .transition()
        .duration(config.animationDuration)
      ...
      groupText
        ...
        .attr('text-anchor', function(d) {
          return false ? //d.id === d.region ? //YOHERE
          //return d.id === d.region ? //YOHERE
            'middle' :
